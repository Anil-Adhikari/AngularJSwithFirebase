myApp.controller('CheckInsController', ['$scope', '$location','$rootScope','$firebaseObject', '$firebaseArray', '$routeParams',
    function($scope, $location, $rootScope, $firebaseObject, $firebaseArray, $routeParams){
